...
learn_hdfs_helper_start() {
    docker run --rm -it -v /Users/amit/Documents/Big_data/Task0_WordsCount:/home/jovyan -p 8888:8888 -p 50070:50070 -p 8088:8088 --name learn_hdfs  bigdatateam/yarn-notebook
}
